                        ...
                        <div className="navbar-breadcrumb">
                           <nav aria-label="breadcrumb">
                              <ul className="breadcrumb mb-0">
                                 ...
                                 <li className="breadcrumb-item active" aria-current="page">All files</li>
                              </ul>
                           </nav>
                        </div>
                                    ...
                                    <div className="table-responsive1">
                                        <table className="table mb-0 table-borderless tbl-server-info">
                                            ...
                                            <tbody>
                                                { files.map(function (file) {
                                                    return (
                                                        <SingleFile view="list" file={ file }
                                                            key={`single-file-list-${ file.id }`}
                                                            callBack={ onInit } />
                                                    )
                                                }) }
                                            </tbody>
...
ReactDOM.createRoot(
    document.getElementById("all-files-app")
).render(<AllFiles />)